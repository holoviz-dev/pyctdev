...
sys.path.insert(
    1, os.path.join(os.path.dirname(__file__), "_vendor", "tox-pep-518.zip")
)
###
...
def task_build_docs():
    ...
    org = {"name": "org", "long": "org", "type": str, "default": ""}
    repo = {"name": "repo", "long": "repo", "type": str, "default": ""}
